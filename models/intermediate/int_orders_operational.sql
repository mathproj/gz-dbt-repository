WITH operational_data AS (
    SELECT
        ...
        (ROUND(o.margin + s.shipping_fee - s.logcost - CAST(s.ship_cost AS FLOAT64),2)) AS operational_margin  -- Calcular el margen operativo
    FROM
    ...
    ORDER BY o.orders_id DESC, o.date_date DESC
)
